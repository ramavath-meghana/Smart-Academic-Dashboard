    ...
    <div className="flex min-h-screen bg-[#f1f4ff]">
      ...
      <aside className="w-80 bg-[#5c67f2] text-white flex flex-col p-8 fixed h-full z-30">
        ...
        <button 
          ...
          className="flex flex-col items-center mb-10 p-6 bg-white/10 rounded-[32px] backdrop-blur-md transition-all hover:bg-white/15 group text-center w-full"
        >
          <div className="relative mb-4">
            <div className="w-24 h-24 rounded-[32px] bg-slate-800/10 flex items-center justify-center border-2 border-white/20 overflow-hidden group-hover:scale-105 transition-transform">
              <User className="w-12 h-12 text-white/50" />
            </div>
            <div className="absolute bottom-1 right-1 w-5 h-5 bg-emerald-400 border-2 border-[#5c67f2] rounded-full shadow-lg" />
          </div>
        ...
        <nav className="flex-1 space-y-2">
          {menuItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center gap-4 px-6 py-4 rounded-2xl text-[11px] font-black transition-all ${
                activeView === item.id 
        ...
        <button 
          ...
          className="mt-auto flex items-center gap-4 px-5 py-4 rounded-2xl text-[10px] font-bold text-white/70 hover:bg-white/5 hover:text-white transition-all"
        >
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Search..."
                className="pl-12 pr-6 py-2.5 bg-slate-50 border border-slate-100 rounded-full outline-none text-xs w-72 transition-all font-bold text-slate-600 focus:bg-white focus:border-blue-400 shadow-inner"
              />
            </div>
            
            <button className="relative w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-slate-400 hover:text-slate-600 transition-all">
            ...
            <div className="flex items-center gap-3 pl-6">
              <button 
                onClick={() => setActiveView('profile')}
                className="flex items-center gap-3 bg-slate-50 p-2 pr-4 rounded-full border border-slate-100 hover:bg-slate-100 transition-all group"
              >
                <div className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center text-slate-400 group-hover:bg-blue-600 group-hover:text-white transition-all overflow-hidden">
