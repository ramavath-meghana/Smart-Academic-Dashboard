        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <select 
                className="w-full p-6 bg-slate-50 border border-slate-100 rounded-lg outline-none text-sm font-black text-slate-700 focus:bg-white focus:border-blue-400 transition-all shadow-inner"
                value={activeSubject}
            ...
            <div>
              ...
              <div className="w-full p-6 bg-blue-50 border border-blue-100 rounded-lg text-sm font-black text-blue-600 flex items-center gap-4">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              <button 
                ...
                className={`py-10 rounded-xl flex flex-col items-center justify-center gap-4 transition-all border-4 ${
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full p-8 bg-slate-50 border border-slate-100 rounded-xl outline-none text-sm font-bold text-slate-700 focus:bg-white focus:border-blue-400 transition-all shadow-inner h-40 resize-none px-10"
              value={comment}
          ...
          <div className="flex justify-center pt-6">
            <button 
              ...
              className="px-14 py-6 bg-blue-600 text-white rounded-lg text-xs font-black uppercase tracking-widest shadow-2xl shadow-blue-500/30 flex items-center gap-4 transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
            >
    ...
    <div className="space-y-10">
      ...
      <div className="bg-white rounded-xl p-12 shadow-sm border border-slate-100">
        <div className="flex items-center justify-between mb-12">
          ...
          <span className="text-xs font-black text-blue-600 bg-blue-50 px-6 py-3 rounded-md uppercase tracking-widest border border-blue-100">Section A - SE Lecture</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-12 mb-12">
          ...
          <div className="text-center p-8 bg-orange-50 rounded-lg border border-orange-100">
          ...
          <div className="text-center p-8 bg-rose-50 rounded-lg border border-rose-100">
        ...
        {/* Progress Bar */}
        <div className="h-6 w-full bg-slate-100 rounded-md flex overflow-hidden shadow-inner">
      ...
      <div className="bg-white rounded-xl p-12 shadow-sm border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {feedbacks.filter(f => f.comment).map((f, i) => (
            <div key={i} className="p-8 bg-slate-50 border border-slate-100 rounded-xl transition-all hover:bg-white hover:shadow-2xl hover:shadow-blue-900/5 group">
              <p className="text-sm font-bold text-slate-600 mb-6 italic leading-relaxed">"{f.comment}"</p>
              <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white rounded-md flex items-center justify-center text-xs font-black text-blue-600 shadow-sm border border-slate-100">
