    ...
    <div className="max-w-5xl mx-auto space-y-10 pb-20">
      ...
      <div className="bg-white rounded-[40px] p-12 shadow-sm border border-slate-100 relative overflow-hidden">
        ...
        <div className="relative pt-12 flex flex-col md:flex-row items-center md:items-end gap-8 px-6">
          <div className="w-40 h-40 rounded-[50px] bg-white p-2 shadow-2xl">
            <div className="w-full h-full rounded-[42px] bg-slate-100 flex items-center justify-center border-4 border-slate-50 overflow-hidden">
          ...
          <div className="flex-1 text-center md:text-left pb-4">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
              <span className="px-5 py-2 bg-blue-50 text-blue-600 rounded-2xl text-xs font-black uppercase tracking-widest border border-blue-100">
                {user.role}
              </span>
          ...
          <button className="mb-4 px-10 py-5 bg-slate-800 text-white rounded-[24px] text-xs font-black uppercase tracking-widest hover:bg-slate-900 transition-all shadow-xl shadow-slate-900/10">
            Edit Information
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-10">
          <div className="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-[40px] p-10 text-white shadow-2xl shadow-blue-900/20">
          ...
          <div className="bg-slate-900 rounded-[40px] p-10 text-white shadow-2xl shadow-slate-900/20">
            ...
            <p className="text-sm font-bold mb-6">Mr. Ramesh Varma</p>
...
function InfoItem({ icon: Icon, label, value }: { icon: any, label: string, value: string }) {
  return (
    <div className="flex items-start gap-6 group">
      <div className="w-12 h-12 bg-slate-50 text-slate-400 rounded-2xl flex items-center justify-center border border-slate-100 group-hover:bg-blue-50 group-hover:text-blue-600 group-hover:border-blue-100 transition-all">
